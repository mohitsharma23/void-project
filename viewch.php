...
<?php
$id = $row['ngoid'];
$retrieve = mysql_query("SELECT * from child where ngoid='$id'");
...
<div class="row">
  ...
  <div class="col-sm-3">
    <img src="showimage.php?kid=<?php echo $id; ?>" height="100px" width="100px"><br>
  </div>
  <div class="col-sm-3">
    <p><strong>Name : </strong><?php echo $fetch['name']; ?></p>
    <p><strong>Date of Birth : </strong><?php echo $fetch['dob']; ?></p>
  </div>
  <div class="col-sm-3">
