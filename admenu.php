...
<a class="navbar-brand" href="adlogin.php"><img src="images/hope.png" style="height:80px;width:150px" alt="logo"></a>
              ...
              <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">Staff
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="addst.php">Add</a></li>
                    <li><a href="updatest.php">Update</a></li>
                    <li><a href="viewst.php">View</a></li>
                  </ul>
              </li>
              <li class="dropdown">
